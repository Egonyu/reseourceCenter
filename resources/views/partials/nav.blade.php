<nav class="section new-nav lg:tw-z-50 tw-py-4 tw-bg-transparent lg:tw-py-3">
  <div class="tw-flex tw-justify-between tw-h-full tw-items-center tw-relative">
    <div
      ...
      class="has-animation xl:tw-flex-1 tw-mr-4 xl:tw-mr-0">
      <a
        class="tw-cursor-pointer tw-leading-none tw-block"
        href="../index.html"
        @click.right.prevent="visitAssetsWebsite">
        <svg
    ...
    <div class="navbar-links tw-relative tw-hidden md:tw-flex md:tw-justify-around tw-text-sm xl:tw-pt-2 xl:tw-w-1/2">
      <a
        class="navbar-link tw-text-white is-active xl:tw-w-1/5 xl:tw-text-center md:tw-px-5 xl:tw-px-0 tw-block tw-uppercase tw-text-transparent-50 tw-font-semibold hover:tw-text-white"
        href="laravel.html">
        Journeys
      </a>

      <a
        class="navbar-link  xl:tw-w-1/5 xl:tw-text-center md:tw-px-5 xl:tw-px-0 tw-block tw-uppercase tw-text-transparent-50 tw-font-semibold hover:tw-text-white"
        href="../seriesa236.html?curated"
        @mouseover="dispatch('ShowSeriesMegaMenu')"
        @mouseout="dispatch('HideSeriesMegaMenu')">
        Series
      </a>
      ...
      <a
        class="navbar-link xl:tw-w-1/5 xl:tw-text-center md:tw-px-5 xl:tw-px-0  tw-relative tw-block tw-uppercase tw-text-transparent-50 tw-font-semibold hover:tw-text-white"
        href="../podcast.html">
        Podcast
      </a>

      <a
        class="navbar-link xl:tw-w-1/5 xl:tw-text-center tw-hidden lg:tw-block  md:tw-px-5 xl:tw-px-0 tw-block tw-uppercase tw-text-transparent-50 tw-font-semibold hover:tw-text-white"
        href="#"
        @click.prevent="$modal.show('testimonials-modal')">
        Testimonials
      </a>
    </div>
    ...
    <div class="tw-hidden md:tw-block tw-relative tw-flex-1">
      <div class="tw-flex tw-items-center tw-justify-end">
        <search-button
          id="search-trigger"
          class="tw-leading-none tw-bg-transparent-10 hover:tw-bg-transparent-25 tw-p-3 tw-rounded-xl">
          <button
            id="search-trigger"
        ...
        <a
          class="tw-text-white hover:tw-text-white link tw-font-bold tw-uppercase tw-mx-6 tw-text-xs"
          href="../login.html"
        ...
        <a
          class="tw-text-white hover:tw-bg-white hover:tw-text-blue tw-font-bold tw-uppercase tw-border tw-rounded-full tw-text-xs tw-px-3 tw-py-2 tw-leading-tight"
          href="../index59f8.html"
          @click.prevent="dispatch('Join')">
          Get Started
        </a>
      </div>
    </div>
