      ...
      <div class="md:tw-flex md:mb-3">
        <div class="md:tw-w-2/5 md:tw-mr-auto">
          ...
          <p class="tw-mb-8 tw-text-white tw-leading-loose">
            Nine out of ten doctors recommend Laracasts over competing brands. Come inside, see
          ...
          <div class="tw-flex tw-w-42 md:tw-w-28 tw-justify-between tw-items-center phone:tw-m-auto mobile:tw-mb-8">
            <a
              ...
              rel="noreferrer">
              <svg
                class="tw-w-8 md:tw-w-6 tw-text-white hover:tw-text-black tw-transition-all"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 16 19">
                <g
        ...
        <div class="md:tw-w-1/6 mobile:tw-mb-6">
          <h5 class="tw-text-white tw-font-bold md:tw-font-semibold tw-mb-2 md:tw-mb-6 tw-uppercase">
            Learn
          </h5>
          ...
          <ul class="tw-leading-loose">
            <li>
              <a
                class="tw-text-transparent-50 hover:tw-text-white"
                href="../index59f8.html"
                @click.prevent="$modal.show('join-modal')">
                Sign Up
              </a>
            </li>
            ...
            <li>
              <a
                class="tw-text-transparent-50 hover:tw-text-white"
                href="../search58d8.html?refinement=type&name=series">
                Browse
              </a>
            </li>
      ...
      <div class="tw-border-t tw-border-solid tw-border-transparent-10 tw-py-4 md:tw-mt-8 mobile:tw-text-lg">
        <div class="tw-text-transparent-50 tw-text-base md:tw-text-xs tw-text-center">
          ...
          <p class="tw-tracking-normal">
            <span class="mobile:tw-block">
              Designed with

              <img
                class="tw-px-1 tw-relative heart-pulse tw-inline"
                alt="heart"
              ...
              <a
                class="tw-font-bold inherits-color link hover:tw-text-white"
                href="https://twitter.com/tudssss">
                Tuds
              </a>
            ...
            <a
              class="tw-font-bold link inherits-color link hover:tw-text-white"
              href="https://www.digitalocean.com/?refcode=d2070a2d5f35">
              DigitalOcean
            </a>
